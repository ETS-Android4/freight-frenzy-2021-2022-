...
@Autonomous(name="CarouselRedVision")
public class CarouselRedVision extends LinearOpMode {
    //
    DcMotor frontleft;
    DcMotor frontright;
    DcMotor backleft;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(detector.boxLeft){
            ...
            gyroDrive(.2, 8.5, 8.5, 8.5, 8.5, 15);
            ...
            gyroDrive(.2, -13.2, -13.2, -13.2, -13.2,10);
            ...
            gyroDrive(.4,4,4,4,4,0);

            liftup(-2, .2);

            close();

            gyroDrive(.4,14,14,14,14,0);
            ...
            strafeToPosition(26, DRIVE_SPEED);
