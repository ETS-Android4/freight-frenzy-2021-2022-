...
//
//    private final Point left    = new Point(70,95);
//    private final Point right    = new Point(140, 150);
//
...
//
//    private RGBColor rightbox;
//    private RGBColor leftbox;
//
...
//        opMode.telemetry.addData("Value: ", leftBoxValue);
...
//        opMode.telemetry.addData("Value: ", rightBoxValue);
//        opMode.telemetry.update();
//        if (rightBoxValue < 200) {
//            return 4;
//
//
//        } else if (rightBoxValue < 290) {
//            return 1;
//
//        } else {
//            return 0;
...
//
//            rightbox = getAverageColor(input, TL, BR);
//            leftbox = getAverageColor(input, TTL, TBR);
//            int thickness = 3;
...
//            Imgproc.rectangle(input, TTL, TBR, Color, thickness);
//
//            //sendTelemetry();
//
//            return input;
