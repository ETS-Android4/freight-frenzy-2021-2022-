...
@Autonomous(name="RedPlacerCarousel")
public class RedPlacerCarousel extends LinearOpMode {
    DcMotor frontleft;
    DcMotor frontright;
    DcMotor backleft;
    DcMotor backright;
    ...
    public void runOpMode(){
        ...
        gyroDrive(motors, DRIVE_SPEED,9.7,9.7,9.7,9.7,0);
        ...
        gyroDrive(motors, DRIVE_SPEED,-15,-15,-15,-15,0);
